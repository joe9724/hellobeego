...
<html class="bg-black">
    <head>
        ...
        <!-- font Awesome -->
        <link href="../static/adminlte/font-awesome-4.5.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
        <link href="../static/adminlte/dist/css/AdminLTE.css" rel="stylesheet" type="text/css" />
        <link href="../static/css/pf.css" rel="stylesheet" type="text/css">
    ...
    <body class="bg-black">
        ...
        <div class="form-box" id="login-box" style="width: 60%;
                                                      height: 60%;
                                                      min-width: 200px;
                                                      max-width: 400px;
                                                      padding: 40px;">
