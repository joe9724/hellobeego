      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/resource/list"><i class="fa fa-circle-o"></i> 资源管理</a></li>
            <li class="/role/list"><a href="index2.html"><i class="fa fa-circle-o"></i> 角色管理</a></li>
            <li class="/grant/list"><a href="index2.html"><i class="fa fa-circle-o"></i> 授权管理</a></li>
            <li class="/userlist/list"><a href="index2.html"><i class="fa fa-circle-o"></i> 用户列表</a></li>
          </ul>
        </li>


        <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>系统设置</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
